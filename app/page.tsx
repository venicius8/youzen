export default function name() {
  ...
  return (
    <main className="bg-green-100 h-300 text-center">
      <div className="relative bg-[url('/morning-nature.jpg')] h-[50vh] bg-cover bg-center flex items-center justify-center mb-10">
        ...
        <span className="absolute inset-x-0 bottom-0 h-1/3 bg-linear-to-b from-transparent via-transparent to-green-100"></span>
      </div>
